...
public class RepositoryImpEN implements Repository{
    ...
    //selects the English DB
    MongoCollection<Travel> travels_collection = database.getCollection("TravelsEN", Travel.class);
