...
public class RepositoryImpAR implements Repository{
    ...
    //selects the Arabic DB
    MongoCollection<Travel> travels_collection = database.getCollection("TravelsAR", Travel.class);
